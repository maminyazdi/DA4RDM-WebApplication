from da4ds.process_mining import ( filter_handler, mining_handler, visualization_handler, conformance_handler )

def run():
    event_data = filter_handler.apply_all_filters() # TODO gleiche Auswahl auch für Options machen? Also z.B. Information about Frequency/Perofrmance??
